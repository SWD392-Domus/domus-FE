          ...
          res?.details?.forEach((detail: any) => {
            detail?.attributes?.forEach((attribute: any) => {
              ...
              if (!attributeExists) {
                ...
                const valueExists = fieldsArray[index].values.some(
                  (value: any) => value.value === attribute.value
                );
                ...
                if (!valueExists) {
                  ...
                  const valueIndex = fieldsArray[index].values.findIndex(
                    (value: any) => value.value === attribute.value
                  );
                  fieldsArray[index].values[valueIndex].ids.push({
                    id: detail.id,
                    price: detail.displayPrice,
                  });
                }
