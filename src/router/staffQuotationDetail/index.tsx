                    ...
                    <div className="left-side-2 basis-1/3">
                        ...
                        <div className="staff-assigned-info my-7">
                            ...
                            <div className="flex flex-row mb-2">
                                <img src={staff.profileImage} alt="" className="h-10 w-10 bg-gray-300 mr-2" />
                                <span className="my-auto font-medium">{staff.userName}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex flex-row flex-wrap">
                                    ...
                                    <div className="right-side-3 basis-2/3">
                                        ...
                                        <div className="ava-header flex flex-row mb-1">
                                            <img src={customer.profileImage} alt="" className="h-10 w-10 bg-gray-300 mr-2" />
                                            <span className="my-auto font-medium">{customer.userName}</span>
                                        </div>
                        ...
                        <div className="nego-info">
                            ...
                            <div className="nego-info-body text-sm">
                                <div className="mail-info flex flex-row mb-1">
                                    ...
                                    <span className="">{negotiationLog?.messages?.length} negotiation chats</span>
                                </div>
                            </div>
                            <div className="my-5">
                                <div className="flex flex-row mb-2">
                            ...
                            {negotiationLog?.messages?.map((nego) => (
                                nego.isCustomerMessage ?
                                    <div className="flex flex-row my-5">
                                        ...
                                        <div className="nego-detail">
                                            ...
                                            <div className="date-info text-xs">Published on {nego.sentAt}</div>

                                            <div className="cmt-info text-sm">{nego.content}
                                            </div>
                                        </div>
                                    </div>
                                    : <div className="flex flex-row my-5">
