                    ...
                    <CardDescription className="pb-2 pt-1 shrink">
                        <p className="truncate">
                            {productDescription ? (
                                ...
                                <p className="truncate">
                                    Materials:Powder-coated aluminum frame.
                                    Marine grade Sunbrella fabric canopy.
                                    Protective cover included. Parasol base
                                    covers will display a slight color
                                    difference compared to the pole. This is in
                                    order to offer an improved resistance to
                                    scratching.
                                </p>
                            )}
                        </p>
