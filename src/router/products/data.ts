export const products = Array.from({ length: 9 }, (_, index) => ({
  ...
  export const productList = [
    ...
    },
    {
        ...
        description: "Upgrade your living room with this sleek mid-century coffee table. Crafted from durable walnut wood, its minimalist design adds a touch of sophistication to your home.",
        price: 249000,
        src: "https://jysk.vn/Data/Sites/1/Product/8362/3602023.jpg",
    },
    {
        id: 3,
        name: "Contemporary Dining Set",
        description: "Host stylish dinners with this contemporary dining set. The table features a glass top and sturdy metal legs, while the chairs boast ergonomic design and faux leather upholstery for maximum comfort.",
        price: 599000,
    ...
    },
    {
        ...
        description: "Create a cozy reading nook with this velvet accent chair. Its deep seat and high back provide exceptional comfort, and the vibrant color options add a pop of personality to your space.",
        price: 349000,
    ...
    },
    {
        ...
        description: "Maximize your storage and display space with these modern floating wall shelves. Crafted from sturdy wood, these shelves are perfect for showcasing books, decor, and personal items.",
        price: 39000,
    ...
    },
    {
        ...
        description: "Indulge in relaxation with this chic leather recliner. Featuring premium leather upholstery and a reclining function, this chair combines style and comfort for the ultimate lounging experience.",
        price: 499000,
        src: "https://cdn11.bigcommerce.com/s-y52856za8c/images/stencil/1200x1200/products/273/4255/AL_Web_ReinventedRecliner_Front_Neeson__26055.1689065486.jpg?c=2",
    },
    {
        id: 7,
        name: "Rustic Farmhouse Bed Frame",
        description: "Transform your bedroom into a cozy retreat with this rustic farmhouse bed frame. Crafted from reclaimed wood, this bed exudes charm and character, making it the focal point of your room.",
        price: 799000,
        src: "https://jysk.vn/Data/Sites/1/Product/10651/720895186-giuong-alnor--xam-dam-jysk-1.jpg",
    },
    {
        id: 8,
        name: "Minimalist Desk and Chair Set",
        description: "Create a stylish and productive workspace with this minimalist desk and chair set. The clean lines and functional design make it ideal for both home offices and study areas.",
        price: 349000,
    ...
    },
    {
        ...
        description: "Illuminate your space with modern flair using this pendant light fixture. Its sleek design and adjustable height make it a perfect addition to dining areas, kitchens, or entryways.",
        price: 129000,
    ...
    },
    {
        ...
        description: "Organize your books and display your favorite decor with this versatile bookcase. Featuring a combination of open shelves and closed storage, it adds both functionality and style to any room.",
        price: 179000,
    ...
    },
    {
        ...
        description: "Define your space with a modern touch using this geometric area rug. The high-quality material and contemporary design make it a stylish and comfortable addition to any room.",
        price: 79000,
