...
const Dashboard: React.FC<Props> = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setContract(res.data.data.contractsCount);
            setQuotation(res.data.data.quotationsCount);
        };
        fetchData();
        getContractsService(
            searchField,
                                ...
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <Card className="border">
                                        ...
                                        <CardContent>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                            The Total quotation of {selectedYear}
                                            </p>
                                        </CardContent>
                                    </Card>
                                    <Card className="border">
                                        ...
                                        <CardContent>
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                            The Total contract signed in {selectedYear}
                                            </p>
                                        </CardContent>
                                    </Card>
                                </div>
