      ...
      "
                >
                    <div className="flex w-auto items-center gap-4 ml-8 mt-4  max-[990px]:pb-10">
                        ...
                        <div className="font-playfair text-6xl text-white">
                            {data.title}
                        </div>
                    </div>
                    <div
                        className="lg:w-[600px] w-full flex justify-center font-openSans 
        ...
        "
                    ...
                    <div
                        className="w-[95%] flex gap-8  -bottom-[100px] lg:-bottom-[120px]  mt-10
        ...
        "
                    >
                        {box.map((item, index) => (
                            <div
                                key={index}
                                className=" lg:w-[170px] lg:h-[170px] w-[100px] h-[120px] shadow-md flex flex-col justify-center gap-4 bg-white items-center"
                            >
                                <img
