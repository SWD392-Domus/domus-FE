  ...
  return (
    ...
    >
      <motion.div className="bg-black max-[940px]:w-screen max-[785px]:h-[1300px] relative w-[80%] h-[600px] shrink z-10 ">
        <motion.div
          className="min-[785px]:w-[45%] w-[100%] z-20 min-[785px]:absolute top-[70px] left-0
          max-[785px]:pt-10"
          variants={slideInFromTop}
        >
          {/* <img src={picture2} className="w-[549px] h-[624px]" /> */}
          <Photo  src={picture2} ratio={183/208}/>
        </motion.div>

        <motion.div 
        initial="hidden" animate="visible"
        className="max-[740px]:flex max-[740px]:flex-col gap-8"
        >
          <motion.div
            variants={slideInFromRight(0.4)}
            className="z-50 lg:w-[600px] w-[auto] shrink gap-4 min-[783px]:absolute text-white left-[350px] top-[150px] 
            
            font-playfair text-6xl flex items-center mx-auto max-[700px]:justify-center mt-4"
          >
            {data.title}
          ...
          >
            ...
            <div className="text-gray-500 shrink text-xl font-playfair ">{data.description2}</div>

            <Button className="w-[30%] mt-8 text-black font-playfair" variant={"yellowCustom"}>
              {data.button.text}
            </Button>
          </motion.div>
        </motion.div>
